...
nts::Tristate nts::C2716::compute(std::size_t pin)
{
    (void)pin;
    return UNDEFINED;
}

void nts::C2716::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    (void)pin;
    (void)other;
    (void)otherPin;
...
std::string nts::C2716::getName() const
{
    return _name;
}