...
nts::Tristate nts::C4801::compute(std::size_t pin)
{
    (void)pin;
    return UNDEFINED;
}

void nts::C4801::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    (void)pin;
    (void)other;
    (void)otherPin;
...
std::string nts::C4801::getName() const
{
    return _name;
}